...
This operator expects IMAGE_PIXEL coordinates. Use to_image_space()
before axdetection() to convert from MODEL_PIXEL to IMAGE_PIXEL.
...
This operator expects IMAGE_PIXEL coordinates. Use to_image_space()
with keypoint_cols parameter before axpose() to convert from MODEL_PIXEL.
