...
**AIPU Acceleration Constraints**
- rule: `auto_pad == "NOTSET"`
- rule: `group == 1 or (W.shape[2] == W.shape[3] and (dilations is None or dilations[0] == dilations[1]) and (strides is None or strides[0] == strides[1]))`
- rule: `group == 1 or (dilations is not None and ((W.shape[2] - 1) * dilations[0] + 1) * ((W.shape[3] - 1) * dilations[1] + 1) < 128) or (dilations is None and W.shape[2] * W.shape[3] < 128)`
